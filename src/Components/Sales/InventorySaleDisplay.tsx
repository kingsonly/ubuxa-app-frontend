...
const InventorySaleDisplay = observer(
  ({
    productData,
    onRemoveProduct,
    setExtraInfoModal,
    ...
    return (
      <div className="flex flex-col gap-2 w-full p-2.5 border-[0.6px] border-strokeGreyThree rounded-[20px]">
        <InventoryDetailRow label="Product Category" value={productTag} />
        <InventoryDetailRow label="Product Name" value={productName} />
        <InventoryDetailRow label="Product Units" value={productUnits} />
        <InventoryDetailRow label="Product Price" value={productPrice} />
...
export default InventorySaleDisplay;
