...
const useTokens = () => {
  ...
  try {
    ...
    return {
      ...
      tenant: {
        id: parsedData?.tenant?.id,
        status: parsedData?.tenant?.status,
        paymentProvider: parsedData?.tenant?.paymentProvider,
        providerPublicKey: parsedData?.tenant?.providerPublicKey,
        logoUrl: parsedData?.tenant?.logoUrl,
        faviconUrl: parsedData?.tenant?.faviconUrl,
        theme: parsedData?.tenant?.theme,
      },
