  ...
  const fetchStoreById = async (id: string) => {
    ...
    if (existingStore) {
      StoreStore.setSelectedStore({
        ...
        description: existingStore.description || undefined,
        address: existingStore.address || undefined,
        phone: existingStore.phone || undefined,
        email: existingStore.email || undefined,
