...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        primaryGradient: "linear-gradient(to right, var(--primary), var(--secondary))",
        errorGradient: "linear-gradient(to right, var(--primary), #473b15)",
        inversedErrorGradient: "linear-gradient(to left, #982214, var(--primary))",
        ...
        paleCreamGradientLeft: "linear-gradient(to left, var(--primary), var(--chalk))",
      },
      boxShadow: {
